...
def main():
    ...
    pub3 = rospy.Publisher('at_side',Float64,queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        #pid = PID(2,0.1,0.00,setpoint=atside_initial)
        # twist.angular.z = 1*side_err*k

        #twist.angular.z = (pid(atside) * k) # Uncomment this if you want to use PID control
